...
`);
var L = (t) => typeof t == "number" && !isNaN(t), N = (t) => typeof t == "string", P = (t) => typeof t == "function", mt = (t) => N(t) || L(t), B = (t) => N(t) || P(t) ? t : null, pt = (t, o) => t === !1 || L(t) && t > 0 ? t : o, z = (t) => (0, import_react.isValidElement)(t) || N(t) || P(t) || L(t);
...
function $({ enter: t, exit: o, appendPosition: e = !1, collapse: r = !0, collapseDuration: s = 300 }) {
	return function({ children: a, position: d, preventExitTransition: c, done: T, nodeRef: g, isIn: v, playToast: x }) {
		let C = e ? `${t}--${d}` : t, S = e ? `${o}--${d}` : o, E = (0, import_react.useRef)(0);
		return (0, import_react.useLayoutEffect)(() => {
			...
			v || (c ? p() : (E.current = 1, f.className += ` ${S}`, f.addEventListener("animationend", p)));
		}, [v]), import_react.createElement(import_react.Fragment, null, a);
	};
}
function J(t, o) {
	return {
...
function gt({ delay: t, isRunning: o, closeToast: e, type: r = "default", hide: s, className: l, controlledProgress: a, progress: d, rtl: c, isIn: T, theme: g }) {
	...
	let C = clsx("Toastify__progress-bar", a ? "Toastify__progress-bar--controlled" : "Toastify__progress-bar--animated", `Toastify__progress-bar-theme--${g}`, `Toastify__progress-bar--${r}`, { ["Toastify__progress-bar--rtl"]: c }), S = P(l) ? l({
		rtl: c,
		type: r,
		defaultClassName: C
	}) : clsx(C, l), E = { [a && d >= 1 ? "onTransitionEnd" : "onAnimationEnd"]: a && d < 1 ? null : () => {
		T && e();
	} };
...
function It(t) {
	var a;
	let { subscribe: o, getSnapshot: e, setProps: r } = (0, import_react.useRef)(Et(t)).current;
	r(t);
	let s = (a = (0, import_react.useSyncExternalStore)(o, e, e)) == null ? void 0 : a.slice();
	function l(d) {
		if (!s) return [];
...
function At(t) {
	let [o, e] = (0, import_react.useState)(!1), [r, s] = (0, import_react.useState)(!1), l = (0, import_react.useRef)(null), a = (0, import_react.useRef)({
		start: 0,
		delta: 0,
		removalDistance: 0,
		canCloseOnClick: !0,
...
var G = ({ theme: t, type: o, isLoading: e, ...r }) => import_react.createElement("svg", {
	viewBox: "0 0 24 24",
	width: "100%",
	height: "100%",
...
function ao(t) {
	return import_react.createElement(G, { ...t }, import_react.createElement("path", { d: "M23.32 17.191L15.438 2.184C14.728.833 13.416 0 11.996 0c-1.42 0-2.733.833-3.443 2.184L.533 17.448a4.744 4.744 0 000 4.368C1.243 23.167 2.555 24 3.975 24h16.05C22.22 24 24 22.044 24 19.632c0-.904-.251-1.746-.68-2.44zm-9.622 1.46c0 1.033-.724 1.823-1.698 1.823s-1.698-.79-1.698-1.822v-.043c0-1.028.724-1.822 1.698-1.822s1.698.79 1.698 1.822v.043zm.039-12.285l-.84 8.06c-.057.581-.408.943-.897.943-.49 0-.84-.367-.896-.942l-.84-8.065c-.057-.624.25-1.095.779-1.095h1.91c.528.005.84.476.784 1.1z" }));
}
function so(t) {
	return import_react.createElement(G, { ...t }, import_react.createElement("path", { d: "M12 0a12 12 0 1012 12A12.013 12.013 0 0012 0zm.25 5a1.5 1.5 0 11-1.5 1.5 1.5 1.5 0 011.5-1.5zm2.25 13.5h-4a1 1 0 010-2h.75a.25.25 0 00.25-.25v-4.5a.25.25 0 00-.25-.25h-.75a1 1 0 010-2h1a2 2 0 012 2v4.75a.25.25 0 00.25.25h.75a1 1 0 110 2z" }));
}
function no(t) {
	return import_react.createElement(G, { ...t }, import_react.createElement("path", { d: "M12 0a12 12 0 1012 12A12.014 12.014 0 0012 0zm6.927 8.2l-6.845 9.289a1.011 1.011 0 01-1.43.188l-4.888-3.908a1 1 0 111.25-1.562l4.076 3.261 6.227-8.451a1 1 0 111.61 1.183z" }));
}
function ro(t) {
	return import_react.createElement(G, { ...t }, import_react.createElement("path", { d: "M11.983 0a12.206 12.206 0 00-8.51 3.653A11.8 11.8 0 000 12.207 11.779 11.779 0 0011.8 24h.214A12.111 12.111 0 0024 11.791 11.766 11.766 0 0011.983 0zM10.5 16.542a1.476 1.476 0 011.449-1.53h.027a1.527 1.527 0 011.523 1.47 1.475 1.475 0 01-1.449 1.53h-.027a1.529 1.529 0 01-1.523-1.47zM11 12.5v-6a1 1 0 012 0v6a1 1 0 11-2 0z" }));
}
function io() {
...
function Nt({ theme: t, type: o, isLoading: e, icon: r }) {
	...
	return r === !1 || (P(r) ? s = r({
		...l,
		isLoading: e
	}) : (0, import_react.isValidElement)(r) ? s = (0, import_react.cloneElement)(r, l) : e ? s = W.spinner() : lo(o) && (s = W[o](l))), s;
}
var wt = (t) => {
	let { isRunning: o, preventExitTransition: e, toastRef: r, eventHandlers: s, playToast: l } = At(t), { closeButton: a, children: d, autoClose: c, onClick: T, type: g, hideProgressBar: v, closeToast: x, transition: C, position: S, className: E, style: f, progressClassName: p, updateId: b, role: i, progress: n, rtl: u, toastId: h, deleteToast: m, isIn: _, isLoading: k, closeOnClick: M, theme: A, ariaLabel: R } = t, D = clsx("Toastify__toast", `Toastify__toast-theme--${A}`, `Toastify__toast--${g}`, { ["Toastify__toast--rtl"]: u }, { ["Toastify__toast--close-on-click"]: M }), Y = P(E) ? E({
		rtl: u,
		position: S,
		type: g,
		defaultClassName: D
	}) : clsx(D, E), ft = Nt(t), dt = !!n || !c, j = {
		closeToast: x,
		type: g,
		theme: A
	}, H = null;
	return a === !1 || (P(a) ? H = a(j) : (0, import_react.isValidElement)(a) ? H = (0, import_react.cloneElement)(a, j) : H = yt(j)), import_react.createElement(C, {
		isIn: _,
		done: m,
		position: S,
	...
	}, ft != null && import_react.createElement("div", { className: clsx("Toastify__toast-icon", { ["Toastify--animate-icon Toastify__zoom-enter"]: !k }) }, ft), tt(d, t, !o), H, !t.customProgressBar && import_react.createElement(gt, {
		...b && !dt ? { key: `p-${b}` } : {},
		rtl: u,
		theme: A,
		delay: c,
...
function Lt(t) {
	let o = {
		..._o,
		...t
	}, e = t.stacked, [r, s] = (0, import_react.useState)(!0), l = (0, import_react.useRef)(null), { getToastToRender: a, isToastActive: d, count: c } = It(o), { className: T, style: g, rtl: v, containerId: x, hotKeys: C } = o;
	function S(f) {
	...
	return Ot(() => {
		...
		return import_react.createElement("div", {
			...
			style: b,
			key: `c-${f}`
		}, p.map(({ content: i, props: n }) => import_react.createElement(wt, {
			...n,
			stacked: e,
			collapseAll: E,
...
//#endregion
export { lt as Bounce, uo as Flip, W as Icons, mo as Slide, Lt as ToastContainer, po as Zoom, Z as collapseToast, $ as cssTransition, y as toast };
